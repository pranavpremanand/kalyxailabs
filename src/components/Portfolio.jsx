  ...
  return (
    <div className="pb-[4rem]">
      <div className="wrapper flex flex-col items-start sm:items-center gap-5">
        ...
        <div className="flex flex-wrap gap-7 justify-center max-w-6xl mx-auto mt-5">
          {portfolioList.map(({ img, id, title }) => (
            <div
              data-aos="fade-up"
              key={id}
              className="w-full sm:w-[calc(50%-1.75rem)] md:w-[calc(33.33%-1.75rem)] p-3 border-2 border-secondary group rounded-xl aspect-square shadow-inner_shadow shadow-secondary/20"
            >
